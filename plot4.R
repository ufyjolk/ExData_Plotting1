...
par(mfrow=c(2,2))
plot(subPower$DateTime, subPower$Global_active_power, type = "l", lty = "solid", col = "black", ylab = "Global Active Power", xlab="")
plot(subPower$DateTime, subPower$Voltage, type = "l", lty = "solid", col = "black", ylab="Voltage", xlab="datetime")
...
plot(subPower$DateTime, subPower$Global_reactive_power, type = "l", lty = "solid", col = "black", ylab = "Global_reactive_power", xlab = "datetime")
dev.off()
